    ...
    <>
      {!isOpen ? null : (
        <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-60 flex items-center justify-center z-50">
          <div ref={modalRef} className="bg-white rounded-lg shadow-lg w-full max-w-sm">
            <div className={`border-b px-4 py-2 flex ${title ? 'justify-between' : 'justify-end'} items-center`}>
